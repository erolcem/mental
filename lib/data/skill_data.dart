...
final List<StatDomain> catalog = [
  StatDomain('INT', 'Intelligence', 0xFF00D4FF, [
    ...
    Skill('science', 'Physics & Chem', '⚗', 'Publish an Original Scientific Result', [
      ...
      _n('sc18', 'Crown: a result the field cites', 12, 'sc17',
          '≥1 independent citation', 40, 'Research'),
    ]),
    ...
    Skill('maths', 'Mathematics', '∑', 'Prove and Publish an Original Theorem', [
      _n('m1', 'Pre-Calculus & Trigonometry', 1, null, 'Timed exam, >90%', 120, 'Foundations'),
      _n('m2', 'Logic & Proofs (Velleman)', 2, 'm1', '200 written proofs', 150, 'Foundations'),
      ...
      _n('m7', 'Real Analysis (Rudin ch. 1–9)', 5, 'm4',
          'All chapter exercises', 350, 'Analysis'),
      ...
      _n('m10', 'Point-Set Topology (Munkres, Part I)', 6, 'm7',
          'All exercises ch. 1–4', 200, 'Analysis'),
      ...
      _n('m5', 'Ordinary Differential Equations (Tenenbaum)', 3, 'm3',
          'Full problem sets', 150, 'Probability'),
      _n('m6', 'Probability (Ross)', 4, 'm3', 'Full problem sets', 200, 'Probability'),
      _n('m11', 'Mathematical Statistics (Casella & Berger)', 7, 'm6',
          'Full problem sets', 250, 'Probability'),
      _n('m13', 'Partial Differential Equations (Evans, Part I)', 8,
          ['m5', 'm12'], 'Full problem sets', 300, 'Probability'),
    ...
    Skill('medicine', 'Medicine', '⚕', 'Chief Attending / Diagnostician', [
      ...
      _n('md2', 'Anatomy (Netter + Anki)', 2, 'md1',
          '2,000-card deck matured', 350, 'Basic Science'),
      _n('md3', 'Physiology (Guyton & Hall)', 3, 'md2',
          'System-by-system self-exams', 300, 'Basic Science'),
      _n('md4', 'Medical Biochemistry (Lippincott)', 3, 'md1',
          'Pathway questions >80%', 200, 'Basic Science'),
      ...
      _n('md9', 'UWorld Step 1 complete', 6, 'md8', '≥70% cumulative', 400, 'Basic Science'),
      ...
      _n('md12', "Internal Medicine (Harrison's core)", 8, 'md10',
          'Chapter self-exams', 300, 'Clinical'),
      ...
      _n('md17', 'MKSAP question bank (ABIM level)', 12, 'md16', '≥65%', 250, 'Diagnosis'),
  ...
  StatDomain('WIS', 'Wisdom', 0xFFC084FC, [
    ...
    Skill('geography', 'Geography', '🌍', 'Global Geospatial Analyst & Forecaster', [
      _n('g1', 'Anki: 196 nations, capitals & flags', 1, null,
          'Matured deck, 95%+ retention', 60, 'Foundations'),
      // — World knowledge —
    ...
    Skill('history', 'History', '📜', 'Master Historian & Archival Synthesis', [
      ...
      _n('h3', 'Durant IV–VI: Middle Ages', 3, 'h2', 'Era synthesis essays', 150, 'Grand Survey'),
      _n('h4', 'Durant VII–XI: Modern Era', 4, 'h3', 'Era synthesis essays', 250, 'Grand Survey'),
    ...
    Skill('business', 'Business', '📊', 'Run Money Like an Institution', [
      ...
      _n('b2', 'Microeconomics (Mankiw)', 1, null, 'Full problem sets', 120, 'Foundations'),
    ...
    Skill('socialSci', 'Social Sci', '🧠', 'Run a Real Behavioral Study', [
      ...
      // — Applied practice —
      _n('ss12', 'Applied Stoicism', 5, 'ss10', '30-day practice journal', 40, 'Practice'),
  ...
  StatDomain('CHA', 'Charisma', 0xFFFB923C, [
    ...
    Skill('japanese', 'Japanese', '🇯🇵', 'N1 + the Spoken Skill JLPT Never Tests', [
      ...
      // — Script & kanji —
      _n('j3', 'Kanji I: 500', 2, 'j1', 'SRS matured', 200, 'Kanji'),
      _n('j5', 'Kanji II: 1,000', 3, 'j3', 'SRS matured', 200, 'Kanji'),
      ...
      _n('j4', 'Genki II', 3, 'j2', 'Workbook + N4 mock ≥70%', 150, 'Grammar'),
      _n('j7', 'Tobira', 5, 'j6', 'All exercises; grammar log', 250, 'Grammar'),
      _n('j13', 'Shin Kanzen Master N2 (all 5)', 7, 'j10', 'Every exercise', 250, 'Grammar'),
      // — Vocabulary & input —
      ...
      _n('j11', 'Core 6k vocabulary', 7, 'j6', 'Matured deck', 300, 'Input'),
    ...
    Skill('khmer', 'Khmer', '🇰🇭', 'Fluency Where No Textbook Ecosystem Exists', [
      ...
      // — Input —
      _n('kh11', 'Input: 100 hrs media/news', 8, 'kh9', 'Log + summaries', 100, 'Input'),
      // — Output —
    ...
    Skill('piano', 'Piano', '🎹', 'The One-Hour Memorised Recital', [
      ...
      _n('p4', 'Minor scales & arpeggios', 3, 'p3', 'Metronome video', 80, 'Technique'),
      ...
      _n('p19', 'ABRSM Grade 5 Performance', 7, ['p6', 'p8'],
          'Video submission or mock', 150, 'Repertoire'),
      ...
      _n('p11', 'Romantic: Chopin nocturne + waltz', 9, ['p10', 'p9'],
          'One-take videos', 200, 'Repertoire'),
    ...
    Skill('singing', 'Singing', '🎤', 'Release an EP and Sing It Live', [
      ...
      _n('v13', 'Perform live: 5 open-mic sets', 11, 'v19',
          'Filmed performances', 40, 'Production'),
  ...
  StatDomain('DEX', 'Dexterity', 0xFF4ADE80, [
    ...
    Skill('writing', 'Writing', '🖊', 'A Published Novel', [
      ...
      _n('w9', 'Prose craft (Zinsser + line edits)', 9, ['w8', 'w18'],
          '3 chapters before/after', 100, 'The Novel'),
    ...
    Skill('memory', 'Memory', '🧩', 'Compete Among the Best from Your Desk', [
      _n('mem1', 'SRS habit: 180-day Anki streak', 1, null, 'Stats export', 60, 'Foundations'),
      // — Systems —
      ...
      _n('mem8', 'Cards: one deck under 3 minutes', 7, ['mem5', 'mem6'],
          'On-camera single take', 60, 'Competition'),
      ...
      _n('mem10', 'Cards: under 90 seconds', 8, 'mem8',
          'On-camera single take', 100, 'Competition'),
    ...
    Skill('karate', 'Karate', '🥋', 'Shodan and Beyond, Honestly Earned', [
      ...
      _n('k4', 'Partner work: gohon/sanbon kumite', 3, 'k2',
          'Logged dojo sessions', 60, 'Kumite'),
