...
final List<StatDomain> catalog = [
  StatDomain('INT', 'Intelligence', const Color(0xFF00D4FF), [
    ...
    Skill('science', 'Physics & Chem', '⚗', 'Publish an Original Scientific Result', [
      ...
      _n('sc24', 'Home Lab I: instruments & measurement', 2, 'sc1',
          'Multimeter, calipers, thermometer: 10 measurements with uncertainty budgets'),
      _n('sc23', 'Error Analysis & Experiment Design (Taylor)', 3,
          ['sc24', 'sc19'],
          'Propagation-of-error problem sets; one designed experiment critiqued'),
      _n('sc25', 'Replicate classic experiments', 4, 'sc23',
          "3 classics with error bars: measure g, laser diffraction, calorimetry"),
    ...
    Skill('maths', 'Mathematics', '∑', 'Prove and Publish an Original Theorem', [
      ...
      _n('m23', 'Combinatorics & Graph Theory', 3, 'm2',
          'Full exercise sets; 30 competition combinatorics problems'),
      ...
      _n('m24', 'Exposition: 10 mathematical essays', 5, 'm19',
          'Ten posts explaining real proofs to a lay reader, published'),
      _n('m25', 'Problem Craft II: full Putnams, timed', 6, 'm19',
          'Two 6-hour Putnams under exam conditions; ≥30/120 self-graded'),
      _n('m26', 'Read research: 10 papers in one field', 9, ['m24', 'm12'],
          'Ten annotated papers; one presented as a talk (recorded)'),
      // — Convergence —
    ...
    Skill('engineering', 'Engineering', '⚙',
      ...
      _n('eg19', 'Unix craft: shell, git, tooling', 2, 'eg1',
          'MIT Missing Semester exercises; dotfiles + 10 scripting katas public'),
      // — Software systems —
      _n('eg5', 'Data Structures & Algorithms', 3, 'eg2',
          'CLRS core + 150 LeetCode, timed log'),
      _n('eg21', 'Compilers (Crafting Interpreters)', 4, 'eg5',
          'Both jlox and clox complete; one language feature of your own added'),
      ...
      _n('eg20', 'Security fundamentals (CTF training)', 7, ['eg11', 'eg19'],
          'picoCTF 2000+ points or pwn.college belt; 10 challenge write-ups'),
      ...
      _n('eg18', 'Crown: 3-node cluster of your kernel + KV store', 10,
          ['eg16', 'eg17', 'eg20', 'eg22'],
          'Kill a node live — the system survives'),
    ]),
  ]),
  StatDomain('WIS', 'Wisdom', const Color(0xFFC084FC), [
    ...
    Skill('geography', 'Geography', '🌍', 'Global Geospatial Analyst & Forecaster', [
      ...
      _n('g19', 'Demography & migration', 5, 'g5',
          'UN population data: 5 charted analyses; migration-corridor brief'),
      ...
      _n('g20', 'Field craft: survey your own region', 4, ['g7', 'g18'],
          'Field notebook + a hand-drawn then QGIS map of your local landscape'),
      ...
      _n('g16', 'Crown: original spatial analysis, published', 8,
          ['g14', 'g15', 'g19'],
          'Write-up + data + code public, forecast record attached'),
    ]),
    ...
    Skill('history', 'History', '📜', 'Master Historian & Archival Synthesis', [
      ...
      _n('h18', 'Historiography: Carr vs Evans', 2, 'h1',
          'What is History? + In Defense of History; your own position essay'),
      ...
      _n('h20', 'Local history: your town from records', 4, 'h11',
          'Census/parish/newspaper archives: 2,000 words on your own street'),
      _n('h19', 'Oral history: 3 recorded interviews', 6, 'h20',
          'Consent-documented recordings, transcriptions + contextual essay'),
      // — Thematic depth —
      ...
      _n('h14', 'Archival project: a real digitised archive', 8,
          ['h13', 'h19'], '10 primary finds transcribed + contextualised'),
    ...
    Skill('business', 'Business', '📊', 'Run Money Like an Institution', [
      ...
      _n('b2', 'Microeconomics (Mankiw)', 1, null, 'Full problem sets'),
      ...
      _n('b23', 'Market history: Graham, Bogle & bubbles', 2, 'b3',
          'Brief on 3 historical bubbles; your IPS updated with the lessons'),
      ...
      _n('b19', 'CFA Level 2', 6, 'b11', 'Full-length timed mock ≥65%'),
      ...
      _n('b15', 'CFA Level 3', 7, 'b19', 'Full-length timed mock ≥65%'),
      // — Strategy & operations —
      ...
      _n('b20', 'Negotiation (Voss + Fisher) in the field', 3, 'b5',
          '10 logged real negotiations with prep sheets + outcomes'),
      _n('b21', 'Micro-venture: legally sell something', 4, ['b10', 'b20'],
          '3 months of a tiny venture: 20+ sales, honest P&L + retrospective'),
      _n('b22', 'Marketing: positioning + landing test', 5, 'b21',
          'Positioning doc; 100-visitor landing-page test, results written up'),
      // — Convergence —
    ...
    Skill('socialSci', 'Social Sci', '🧠', 'Run a Real Behavioral Study', [
      ...
      _n('ss20', 'Behavioral Economics — audited', 5, ['ss8', 'ss18'],
          'Misbehaving + Ariely annotated with replication status; 10 nudges judged'),
      _n('ss11', 'Behave (Sapolsky)', 6, ['ss3', 'ss9'],
          'Multi-level analysis of one behaviour'),
      // — Applied practice —
      _n('ss12', 'Applied Stoicism', 5, 'ss10', '30-day practice journal'),
      _n('ss19', 'Ethnography: 20 hrs public observation', 6, 'ss9',
          'Anonymised, ethics-aware field-note corpus + thematic write-up'),
      _n('ss21', 'Wellbeing science + 8-week practice', 6, 'ss12',
          "Yale's Science of Well-Being; 8 weeks of tracked practice, honest data"),
  ...
  StatDomain('CHA', 'Charisma', const Color(0xFFFB923C), [
    ...
    Skill('english', 'English', '🔤', 'Command the Room and the Page', [
      ...
      _n('e16', 'GRE Verbal', 3, 'e4', 'ETS POWERPREP timed, ≥163'),
      // — Writing craft —
      _n('e17', 'Close reading: poetry & prose', 3, 'e1',
          '15 close readings; 5 poems memorised and recited'),
      _n('e20', 'Style imitation: 10 pastiches', 4, 'e17',
          '10 passages imitated (Orwell→Didion); what each taught, noted'),
      ...
      _n('e19', 'Storytelling: 5 true stories, Moth rules', 6, 'e11',
          '5 filmed 5-min stories, no notes; one told to a live audience'),
      // — Argument & analysis —
      _n('e5', 'Logical Fallacies & Argument', 2, 'e1',
          '30 fallacies catalogued from real media'),
      _n('e18', 'Debate: 10 formal debates', 7, ['e13', 'e5'],
          '10 debates in an online club; 3 filmed + rebuttals self-scored'),
      // — Convergence —
    ...
    Skill('turkish', 'Turkish', '🇹🇷', 'C1+ and Real-Time Interpretation', [
      ...
      _n('tr5', 'B2 grammar: chains, conditionals, evidentiality', 5, 'tr4',
          'Every structure drilled both ways; error log kept'),
      ...
      _n('tr15', 'Vocabulary: 5,000-word SRS', 5, 'tr4',
          'Deck built from your own input; sampled retention ≥90%'),
      ...
      _n('tr18', 'Scripted speaking: 20 monologues', 4, 'tr3',
          '20 recorded 2-min monologues; native feedback on 5'),
      ...
      _n('tr19', 'Writing I: 20 corrected texts', 6, 'tr5',
          'LangCorrect archive; error classes tracked and shrinking'),
      ...
      _n('tr16', 'Music & lyrics: 30 songs', 2, 'tr1',
          '30 songs studied; 10 sung or recited from memory'),
      _n('tr17', 'Culture & history of Türkiye', 3, 'tr2',
          'A short history read; 10 culture briefs (customs, regions, cuisine)'),
      // — Convergence —
    ...
    Skill('japanese', 'Japanese', '🇯🇵', 'N1 + the Spoken Skill JLPT Never Tests', [
      ...
      _n('j13', 'Shin Kanzen Master N2 (all 5)', 7, 'j10', 'Every exercise'),
      // — Vocabulary & input —
      ...
      _n('j21', 'Input II: 250 total hours', 8, ['j9', 'j12'],
          'Log at 250 hrs; a 20-min drama episode summarised, no subs'),
      // — Output —
      _n('j19', 'Pitch accent + shadowing I', 3, 'j2',
          'Minimal-pair test ≥90%; 10 shadowed clips, pitch self-compared'),
      _n('j20', 'Writing I: 30 corrected journal entries', 6, 'j7',
          'LangCorrect/HelloTalk archive; error log shrinking'),
      ...
      _n('j22', 'Culture: customs & geography of Japan', 4, 'j4',
          '20 culture briefs; a Japan geography deck matured'),
    ...
    Skill('khmer', 'Khmer', '🇰🇭', 'Fluency Where No Textbook Ecosystem Exists', [
      ...
      _n('kh15', 'Digital Khmer: typing & tools', 2, 'kh1',
          'Type 15 wpm in Khmer Unicode; phone + desktop setup documented'),
      ...
      // — Input —
      _n('kh11', 'Input: 100 hrs media/news', 8, 'kh9', 'Log + summaries'),
      // — Output —
      _n('kh18', 'First output: 10 exchanges', 4, 'kh3',
          '10 short exchanges (HelloTalk/tutor); 5 recorded dialogues corrected'),
      _n('kh7', 'Conversation: 25 logged hours', 6, ['kh5', 'kh18'],
          "Session log + tutor's written assessment"),
      _n('kh16', 'Songs & karaoke: 20 songs', 7, 'kh7',
          '20 songs studied; 5 sung with lyrics from memory'),
      ...
      _n('kh17', 'Culture & history (Chandler)', 2, 'kh1',
          "A History of Cambodia read; 10 culture briefs written"),
      _n('kh13', 'Traditional literature (Reamker excerpts)', 9,
          ['kh10', 'kh17'], 'Reading journal with cultural notes'),
      // — Convergence —
    ...
    Skill('musicTheory', 'Music Theory', '🎼', 'Compose and Hear It Performed', [
      ...
      _n('mt20', 'Ear training III: transcription', 8, 'mt15',
          'Transcribe 10 songs (melody + chords) and 5 chorale phrases by ear'),
      // — Rhythm —
      _n('mt19', 'Rhythm I: reading & clapping', 2, 'mt1',
          '20 rhythms clapped at tempo from notation, recorded'),
      // — Composition: begins early, grows with the theory —
      _n('mt16', 'Composition I: 12 eight-bar melodies', 3, 'mt2',
          'Notated in MuseScore; 3 peer critiques gathered'),
      _n('mt17', 'Composition II: theme & 5 variations', 6, ['mt16', 'mt5'],
          'Score + render; harmonic analysis of your own piece attached'),
      _n('mt18', 'Jazz & pop harmony', 7, 'mt7',
          'Levine chapters worked; 10 standards analysed; 5 reharmonisations'),
    ...
    Skill('piano', 'Piano', '🎹', 'The One-Hour Memorised Recital', [
      ...
      _n('p20', 'Improvisation I: blues & pentatonic', 4, 'p7',
          '10 recorded improvisations over backing tracks; honest self-review'),
      _n('p22', 'Accompany: play with others', 7, ['p20', 'p21'],
          'Accompany a singer or instrumentalist on 5 songs, recorded'),
      // — Repertoire spine —
      ...
      _n('p21', 'Performance ritual: monthly one-takes', 6, 'p18',
          '6 months of monthly one-take videos; log of nerves and fixes'),
      _n('p23', 'Memorisation craft', 8, 'p19',
          'Memorise 3 pieces via analysis; test: restart from any section'),
      // — Convergence —
    ...
    Skill('singing', 'Singing', '🎤', 'Release an EP and Sing It Live', [
      ...
      _n('v17', 'Vocal health & anatomy', 2, 'v1',
          'How the voice works, summarised; warm-up routine; strain red-flags'),
      ...
      _n('v21', 'Ear for singers: intervals & harmony', 3, 'v2',
          'Interval singing ≥90%; root/3rd/5th sung against drones'),
      _n('v18', 'Harmony singing: duets', 7, ['v21', 'v16'],
          '5 duet/harmony recordings (virtual duets fine); pitch-checked'),
      // — Repertoire & style —
  ...
  StatDomain('DEX', 'Dexterity', const Color(0xFF4ADE80), [
    ...
    Skill('drawing', 'Drawing', '✏️', 'A Body of Work Worth Exhibiting', [
      ...
      _n('d19', 'Master studies: 10 copies', 6, 'd17',
          'Ten master copies (Rubens/Sargent/Bridgman); deviations annotated'),
      ...
      _n('d18', 'Sketchbook habit: 100 consecutive days', 2, 'd1',
          'Dated pages, 100-day streak; monthly self-critique'),
      ...
      _n('d20', 'Digital craft (Krita/Procreate)', 8, 'd9',
          '5 studies replicating your traditional values and color digitally'),
    ...
    Skill('writing', 'Writing', '🖊', 'A Published Novel', [
      ...
      _n('w20', 'Genre immersion: 20 books', 3, 'w2',
          'Genre map: tropes, expectations, comp titles; reading journal'),
      // — Craft study —
      _n('w18', 'Prose rhythm: poetry & sentences', 2, 'w1',
          '30 poems studied; 20 sentence imitations, before/after'),
      ...
      _n('w19', 'Research & world-building bible', 5, 'w20',
          'Story bible: places, cast, timeline, research notes with sources'),
      ...
      _n('w17', 'Flash & short: submit 10 pieces', 5, 'w16',
          '10 submissions logged (Duotrope); rejections collected proudly'),
      _n('w21', 'Place a short story', 8, 'w17',
          'One story accepted anywhere real, or 3 personal rejections earned'),
    ...
    Skill('cooking', 'Cooking', '🍳', 'Chef of Your Own Table', [
      ...
      _n('c17', 'Food science (McGee)', 2, 'c1',
          'Chapter notes; 10 kitchen experiments explained (rest, brine, sear)'),
      _n('c20', 'Sharpening & tool care', 3, 'c2',
          'Whetstone progression video; paper-slice test; care log'),
      ...
      _n('c21', 'Pastry: desserts & lamination', 7, 'c7',
          'Croissants, tart, custards; lamination layers photographed'),
      ...
      _n('c18', 'Plating & presentation', 8, ['c16', 'c10'],
          '10 plated dishes vs reference plating; natural-light photos'),
      _n('c19', 'Menu craft: plan & cost 5 menus', 9, 'c18',
          '5 costed menus with prep timelines; one executed on budget'),
      // — Convergence —
    ...
    Skill('mechanics', 'Mechanics', '🔧', 'Rebuild It Yourself', [
      ...
      _n('m16', 'Bicycle: full tune-up', 2, 'm1',
          'Brakes, gears, bearings serviced; Park Tool checklist; ride test'),
      ...
      _n('m17', 'Woodworking I: build a workbench', 3, 'm3',
          'Square, level bench from plans; joinery photos; technique video'),
      _n('m18', 'CAD + 3D printing', 4, 'm17',
          'Three designed-and-printed functional parts; tolerances measured'),
      _n('m19', 'Metalwork & fasteners', 5, 'm18',
          'Tap & die practice; a steel bracket made; makerspace intro class ok'),
      // — Convergence —
    ...
    Skill('memory', 'Memory', '🧩', 'Compete Among the Best from Your Desk', [
      ...
      _n('mem14', 'Learning science (Make It Stick)', 2, 'mem1',
          'Retrieval + interleaving applied to one subject for a month, logged'),
      // — Applied memory: real knowledge, kept forever —
      _n('mem15', 'Applied I: a poem and a speech', 3, 'mem2',
          '100-line poem + 10-min speech recited on camera, palace maps shown'),
      _n('mem16', 'Applied II: a knowledge vault', 5, ['mem15', 'mem14'],
          'Periodic table, world capitals, 50 constellations: cold-tested ≥95%'),
      // — Competition drills —
      ...
      _n('mem17', 'Names in the wild', 7, 'mem7',
          '50 real people remembered a week later; verified log'),
    ...
    Skill('karate', 'Karate', '🥋', 'Shodan and Beyond, Honestly Earned', [
      ...
      _n('k16', 'Dojo Japanese: terms & etiquette', 2, 'k1',
          'Terminology deck matured: counting, commands, kata names'),
      _n('k17', 'History & philosophy (Funakoshi)', 4, 'k16',
          'Karate-Do: My Way of Life + precepts; essay: what karate is for'),
      _n('k18', 'Rules & judging literacy', 6, ['k5', 'k17'],
          'WKF/JKA rules summarised; 10 recorded matches scored vs officials'),
